...
(function() {
  var async, clear, construct_class, construct_class_field, construct_classes_from_dir, construct_classes_from_file, constructed_artifacts, cradle, db, fs, init, path,
    _this = this;
  ...
  construct_class = function(default_name, template) {
    ...
    module.exports[name] = function() {
      ...
      this.save = function() {
        console.log( this, db);
        db.save( this, function(err, res) {
          if (err) {
            return console.log('---', err, res);
          } else {
            return console.log('Saved', res);
          }
        });
        return void 0;
      };
